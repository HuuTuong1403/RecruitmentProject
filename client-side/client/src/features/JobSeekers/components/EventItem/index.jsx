  ...
  return (
    <div className={classes.eventItem}>
      ...
      <div className={classes.eventItem__top}>
        <img
          className={classes["eventItem__top--cover"]}
          src={imageCover}
          alt={imageCover}
        />
        <img
          className={classes["eventItem__top--logo"]}
          src={logo}
          alt={logo}
        />
        {!isNew && (
      ...
      <div className={classes.eventItem__bottom}>
        <div className={classes["eventItem__bottom--title"]}>
          ...
          {companyName && (
            <Tooltip
              title={`${t("Click to see details of company")} ${companyName}`}
            >
              <Link to={`/jobs/employer/${companyName}`}>{companyName}</Link>
            </Tooltip>
          )}
        </div>
        {/* Event location */}
        ...
        <div className={classes["eventItem__bottom--field"]}>
          ...
          {t("Registered to participate on")}:{" "}
          <span>{`${t("Date")} ${dateRegister}`}</span>
        </div>
      </div>
